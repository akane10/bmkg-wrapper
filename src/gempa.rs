...
fn parsing_data(data: &str) -> Vec<(Key, Value)> {
...
mod tests {
    ...
    #[test]
    fn to_json_test() {
        let vec = [("Tanggal", "30-Jul-20"), ("Jam", "09:51:20 WIB")].to_vec();

        let vec1 = [("Tanggal", "30-Jul-21"), ("Jam", "05:51:20 WIB")].to_vec();

        let i =
            serde_json::from_str(r#"{ "Tanggal": "30-Jul-20", "Jam": "09:51:20 WIB"}"#).unwrap();
        let ii =
            serde_json::from_str(r#"{ "Tanggal": "30-Jul-21", "Jam": "05:51:20 WIB"}"#).unwrap();
